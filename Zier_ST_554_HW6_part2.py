...
#calling before running simulations
...
# probability calc
print(f" The probability is:", slope_sim.find_prob(2.1, "two-sided"))

#print slopes
print("The simulated slopes are as follows:")
print(slope_sim.slopes)
